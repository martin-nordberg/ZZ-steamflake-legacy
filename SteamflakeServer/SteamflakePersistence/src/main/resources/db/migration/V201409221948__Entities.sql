...
-- Primary key
ALTER TABLE NAMED_ENTITY ADD CONSTRAINT PK_NAMED_ENTITY
    PRIMARY KEY (ID);
...
-- Primary key
ALTER TABLE ABSTRACT_NAMESPACE ADD CONSTRAINT PK_ABSTRACT_NAMESPACE
    PRIMARY KEY (ID);
...
-- Primary key
ALTER TABLE NAMESPACE ADD CONSTRAINT PK_NAMESPACE
    PRIMARY KEY (ID);
...
-- Primary key
ALTER TABLE ROOT_NAMESPACE ADD CONSTRAINT PK_ROOT_NAMESPACE
    PRIMARY KEY (ID);
...
ALTER TABLE ROOT_NAMESPACE ADD CONSTRAINT UQ_ROOT_NAMESPACE__SINGLE_ROW_ENFORCEMENT
    UNIQUE (SINGLE_ROW_ENFORCEMENT);
ALTER TABLE ROOT_NAMESPACE ADD CONSTRAINT CHK_ROOT_NAMESPACE__SINGLE_ROW
    CHECK (SINGLE_ROW_ENFORCEMENT = TRUE);
