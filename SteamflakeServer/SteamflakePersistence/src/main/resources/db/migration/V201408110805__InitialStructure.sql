...
SELECT MODEL_ELEMENT.ID ID,
       MODEL_ELEMENT.PARENT_CONTAINER_ID PARENT_CONTAINER_ID,
...
INSERT INTO MODEL_ELEMENT (ID, PARENT_CONTAINER_ID, SUMMARY, TYPE)
     VALUES ('bf6d4bfc-b169-4919-8712-05e54484921e', 'bf6d4bfc-b169-4919-8712-05e54484921e', '(Top level namespace)', 'RootNamespace');
...
ALTER TABLE MODEL_ELEMENT ADD CONSTRAINT FK_MODEL_ELEMENT__CONTAINER_ELEMENT
  FOREIGN KEY (PARENT_CONTAINER_ID) REFERENCES CONTAINER_ELEMENT(ID) ON DELETE CASCADE;
