...
declare module "mongodb" {
    ...
    export class ObjectID {
        ...
        // time â€“ an integer number representing a number of seconds.
        public static createFromTime(time: number): ObjectID;

        // Creates an ObjectID from a hex string representation of an ObjectID.
        // hexString â€“ create a ObjectID from a passed in 24 byte hexstring.
    ...
    export interface SocketOptions {
        ...
        keepAlive?: number;
        //= â€˜asciiâ€™|â€™utf8â€™|â€™base64â€™ default:null
        encoding?: string;
    }
    ...
    export interface DbCreateOptions {
        //  the write concern for the operation where < 1 is no acknowlegement of write and w >= 1, w = â€˜majorityâ€™ or tag acknowledges the write.
        w?: string;
        ...
        // when deserializing a Long will fit it into a Number if itâ€™s smaller than 53 bits. default:true.
